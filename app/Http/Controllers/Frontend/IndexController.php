...
//    }
    ...
    public function ProductDetails($id, $slug)
    {
        ...
        return view('front.product.product_details', compact('product', 'multiImag', 'product_color_en', 'product_color_hin', 'product_size_en', 'product_size_hin', 'relatedProduct'));
