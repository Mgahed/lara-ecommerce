                            ...
                            <div class="table-responsive">
                                ...
                                <form method="post" action="{{ route('division.update',$division->id) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input autocomplete="off" type="text" style="direction: ltr;" name="name_en" class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input autocomplete="off" type="text" style="direction: rtl;" name="name_ar" class="form-control"
